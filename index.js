const contentLetterSrart_actived = "Anh rất vui khi có em trong cuộc đời của anh. Cảm ơn em vì tất cả những điều tuyệt vời em đã làm cho anh. Mong em có một ngày sinh nhật thật vui và hạnh phúc nhaa. Chúc mừng sinh nhật tình yêu của anh!" //Lời mở đầu cho bức thư
const mainContentLetter = " Chúc em bé của anh trong túi có tiền, trong lòng có anh nhaa :3. Đỗ Trần Thúy Linh, anh yêu em nhiều lắmmm." //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/img2.jpg";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/abc.jpg"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
